  ...
  return (
    <div className="min-h-screen w-full flex bg-background relative">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        {/* Mobile header */}
        <div className="lg:hidden flex items-center justify-between px-4 py-3 border-b border-border/50 backdrop-blur-xl bg-background/60">
        ...
        <header className="hidden lg:flex h-16 items-center justify-between px-8 border-b border-border/50 backdrop-blur-xl bg-background/40 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="h-9 w-9 rounded-full bg-gradient-primary grid place-items-center text-xs font-semibold text-primary-foreground" aria-label="User Profile">SA</div>
          </div>
        </header>
